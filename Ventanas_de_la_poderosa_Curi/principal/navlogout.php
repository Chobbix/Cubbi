<header class="header">
    <nav class="nav">           
        ...
        <ul class="nav-menu">                 
                ...
                <li><a href="#" class="clase-a">Cursos <i class="fas fa-angle-down"></i></a>                    
                    <ul class="longitud">
                        <li><a href="#" >Categorias </a>                            
                            <ul class="diseno">
                                <scroll-container>
                                    <li><a href="../Login/login.php">Azucar </a></li>
                                    <li><a href="../Login/login.php">leche</a></li>
                                    <li><a href="../Login/login.php">huevos</a></li>
                                    <li><a href="../Login/login.php">Azucar</a></li>                                                                                     
                                </scroll-container>
                            </ul>
                        </li>
            ...
            <li><a href="../Login/login.php" class="nav-item buscador "> <i class="fas fa-search"></i></a></li>
