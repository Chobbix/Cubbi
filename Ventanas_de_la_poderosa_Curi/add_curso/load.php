...
<div class="contenedor">
        <div class="menus">
            ...
            <div class="contenedor-categoria">
                ...
                <label for="diplomas"><h2 class="design-tittle">Tus cursos</h2>  </label>
                <label for="guardados"><h2 class="design-tittle">Informacion cursos </h2>  </label>
            </div>        
                        ...
                        <div class="cabecera"> 
                            ...
                            <div class="hi">
                                <div   div class="bontones_seleccion">
                                    <label for="Info"><h1 class="text_decoration">informacion general</h1></label>
                                </div>
                                                    ...
                                                    <ul class="nav-filtro">
                                                        <li> <a href="#" class="diseño"> <h1 class="filtro_texto_diseñp">Filtro <i class="fas fa-angle-down"></i></h1></a> 
                                                            <ul>
                                                                ...
                                                                <li> <a href="#">  <label for="sinver"><h2 class="design-filtro">Curso especifico</h2> </label></a> </li>                                                         
                                                            </ul>
                                                        </li>
                                                    </ul>
                                                </div>  
                                            ...
                                            <div class="bloque-menu"  id="filtrado">   
                                                <div class="contenedor-Todos container-dis">
                                                    ...
                                                    <div class="bloque-containeer">  
                                                        <div class="container">
                                                            <div class="puntuacion"> <i class="far fa-heart"></i> <h1>520 alumnos les gusta tus curso</h1></div>
                                                            <div class="puntuacion"><i class="fas fa-users"></i><h1>525 alumnos</h1></div>
                                                            <div class="puntuacion"> <i class="fas fa-coins"></i><h1>Generaste $1200 pesos</h1></div>                                                            
                                                        </div>
                                                    </div>                                                                                                                              
                                                </div>                                                                                  
