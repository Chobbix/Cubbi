...
$(document).ready(function(){
    ...
    $('.add_categoria').click(function(){
        ...
        $.ajax({
            data: form_categoria,
            url: 'http://cubbi.proyectoslmad.xyz/Controladores/db_agregar_categoria.php',
            method: 'POST',
            contentType: false,
            processData: false,
        })
    ...
    $("[btnGuardar=Agregar]").click(function(){
        ...
        $.ajax({
            data: form_data,
            url: 'http://cubbi.proyectoslmad.xyz/Controladores/db_agregar_curso.php',
            method: 'POST',
            contentType: false,
            processData: false,
        })
        ...
        $(".bloque_nivel").each(function(index, element){
            ...
            $.ajax({
                data: form_datasec,
                url: 'http://cubbi.proyectoslmad.xyz/Controladores/db_agregar_temas.php',
                method: 'POST',
                contentType: false,
                processData: false,
            })
            ...
            $($(element).children(".cabecera_nivel").children()).each(function(index, element){
                ...
                $.ajax({
                    data: form_dataCap,
                    url: 'http://cubbi.proyectoslmad.xyz/Controladores/db_agregar_capitulos.php',
                    method: 'POST',
                    contentType: false,
                    processData: false,
                })
    ...
    $("[btnGuardar=Editar]").click(function(){
        ...
        $.ajax({
            data: form_data,
            url: 'http://cubbi.proyectoslmad.xyz/Controladores/db_modificar_curso.php',
            method: 'POST',
            contentType: false,
            processData: false,
        })
        ...
        $(".bloque_nivel").each(function(index, element){
            ...
            if(isViejo != "true") {
                ...
                $.ajax({
                    data: form_datasec,
                    url: 'http://cubbi.proyectoslmad.xyz/Controladores/db_agregar_temas_by_curso.php',
                    method: 'POST',
                    contentType: false,
                    processData: false,
                })
            ...
            $($(element).children(".cabecera_nivel").children()).each(function(index, element){
                ...
                if(isViejo != "true") {
                    $.ajax({
                        data: form_dataCap,
                        url: 'http://cubbi.proyectoslmad.xyz/Controladores/db_agregar_capitulos_by_curso.php',
                        method: 'POST',
                        contentType: false,
                        processData: false,
                    })
                    ...
                    $.ajax({
                        data: form_dataCap,
                        url: 'http://cubbi.proyectoslmad.xyz/Controladores/db_modificar_capitulos.php',
                        method: 'POST',
                        contentType: false,
                        processData: false,
                    })
...
function sendRequest() {
    ...
    theObject.open('GET', 'http://cubbi.proyectoslmad.xyz/Controladores/db_agregar_curso.php', true);
